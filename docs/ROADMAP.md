...
| **5.3.0** | **Pocket Stage** — Przywróć (`.bak` / ZIP), opcjonalny Sentry, APK Performer/Console | **Wydane 2026-07-25** — tag `v5.3.0` | [CHANGELOG](../CHANGELOG.md) · [TODO.md](./TODO.md) · [MOBILE.md](./MOBILE.md) |
| **5.3+** | Residual: multi-out HW, auto-election, Offline delta, JNI, OAuth… | Po 5.3.0 | [TODO.md](./TODO.md) · [spec-5.2+](./analysis/inspiracje/spec-5.2+/) |
...
### 5.3.0 — **Pocket Stage** — **wydane 2026-07-25**
