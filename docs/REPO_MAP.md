...
* **Liczba wszystkich plików:** 1392
* **Liczba katalogów:** 212
* **Data aktualizacji:** 2026-08-11T03:30:31.022Z
...
- **apps/** (998) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (549) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (507) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (244) — Powłoki Admin / Client / Timeline
