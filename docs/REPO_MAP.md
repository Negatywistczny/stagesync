...
* **Liczba wszystkich plików:** 1559
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T16:16:16.728Z
...
- **apps/** (1154) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (687) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (645) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (364) — Powłoki Admin / Client / Timeline
...
│   │   │   ├── shells/
│   │   │   │   ├── admin/  … (49 plików, 5 podkatalogów; 34 pliki bezpośrednio)
