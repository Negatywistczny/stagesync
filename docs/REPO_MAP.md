...
* **Liczba wszystkich plików:** 1397
* **Liczba katalogów:** 212
* **Data aktualizacji:** 2026-08-11T03:32:48.506Z
...
- **apps/** (1003) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (554) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (512) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (249) — Powłoki Admin / Client / Timeline
