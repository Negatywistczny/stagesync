...
* **Data aktualizacji:** 2026-08-12T16:20:28.497Z
...
- **apps/** (1161) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (694) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (652) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (371) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (144 pliki, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
