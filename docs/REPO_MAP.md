...
* **Liczba wszystkich plików:** 1515
* **Liczba katalogów:** 252
* **Data aktualizacji:** 2026-08-11T22:39:42.906Z
...
- **apps/** (1111) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (631) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (589) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (308) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (95 plików, 9 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
