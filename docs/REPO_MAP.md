...
* **Liczba wszystkich plików:** 1575
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T18:22:42.620Z
...
- **apps/** (1170) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (703) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (661) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (380) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (153 pliki, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
