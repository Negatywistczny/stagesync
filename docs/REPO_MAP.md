...
* **Liczba wszystkich plików:** 1593
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T18:38:58.958Z
...
- **apps/** (1188) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (721) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (679) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (398) — Powłoki Admin / Client / Timeline
...
│   │   │   ├── shells/
│   │   │   │   ├── admin/  … (50 plików, 5 podkatalogów; 35 plików bezpośrednio)
│   │   │   │   ├── client/  … (37 plików, 1 podkatalog; 36 plików bezpośrednio)
│   │   │   │   ├── components/  … (59 plików, 1 podkatalog; 50 plików bezpośrednio)
│   │   │   │   ├── desktop/  … (21 plików)
│   │   │   │   ├── import/  … (39 plików, 1 podkatalog; 34 pliki bezpośrednio)
│   │   │   │   ├── pages/  … (3 pliki)
│   │   │   │   ├── settings/  … (24 pliki, 1 podkatalog; 18 plików bezpośrednio)
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (163 pliki, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
