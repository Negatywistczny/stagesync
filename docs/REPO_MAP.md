...
* **Liczba wszystkich plików:** 1541
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T03:26:18.070Z
...
- **apps/** (1137) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (657) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (615) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (334) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (121 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
