...
* **Data aktualizacji:** 2026-08-11T02:09:11.923Z
...
- **apps/** (922) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (487) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (445) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (196) — Powłoki Admin / Client / Timeline
