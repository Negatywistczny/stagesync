...
* **Liczba wszystkich plików:** 1585
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T18:34:37.408Z
...
- **apps/** (1180) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (713) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (671) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (390) — Powłoki Admin / Client / Timeline
