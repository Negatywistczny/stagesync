...
* **Liczba wszystkich plików:** 1560
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T16:18:00.954Z
...
- **apps/** (1155) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (688) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (646) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (365) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (138 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
