...
* **Liczba wszystkich plików:** 1514
* **Liczba katalogów:** 252
* **Data aktualizacji:** 2026-08-11T22:34:55.558Z
...
- **apps/** (1110) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (630) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (588) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (307) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (94 pliki, 9 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
