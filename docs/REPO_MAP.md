...
* **Liczba wszystkich plików:** 1538
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T03:06:21.198Z
...
- **apps/** (1134) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (654) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (612) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (331) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (118 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
