...
* **Liczba wszystkich plików:** 1583
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T18:33:52.526Z
...
- **apps/** (1178) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (711) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (669) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (388) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (161 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
