...
* **Liczba wszystkich plików:** 1517
* **Liczba katalogów:** 252
* **Data aktualizacji:** 2026-08-11T22:48:01.919Z
...
- **apps/** (1113) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (633) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (591) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (310) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (97 plików, 9 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
