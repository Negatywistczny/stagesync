...
* **Liczba wszystkich plików:** 1400
* **Liczba katalogów:** 213
* **Data aktualizacji:** 2026-08-11T03:35:26.592Z
...
- **apps/** (1006) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (557) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (515) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (252) — Powłoki Admin / Client / Timeline
...
│   │   │   ├── shells/
│   │   │   │   ├── admin/  … (39 plików, 5 podkatalogów; 24 pliki bezpośrednio)
│   │   │   │   ├── client/  … (17 plików)
