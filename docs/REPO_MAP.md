...
* **Liczba wszystkich plików:** 1520
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-11T22:51:27.215Z
...
- **apps/** (1116) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (636) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (594) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (313) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (100 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
