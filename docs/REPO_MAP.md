...
* **Liczba wszystkich plików:** 1285
* **Liczba katalogów:** 197
* **Data aktualizacji:** 2026-08-11T02:08:48.681Z
...
- **apps/** (919) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (484) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (442) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (193) — Powłoki Admin / Client / Timeline
