...
* **Liczba wszystkich plików:** 1292
* **Liczba katalogów:** 197
* **Data aktualizacji:** 2026-08-11T02:09:33.962Z
...
- **apps/** (926) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (491) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (449) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (200) — Powłoki Admin / Client / Timeline
