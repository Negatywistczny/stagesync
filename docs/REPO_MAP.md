...
* **Liczba wszystkich plików:** 1513
* **Liczba katalogów:** 252
* **Data aktualizacji:** 2026-08-11T22:23:36.099Z
...
- **apps/** (1109) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (629) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (587) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (306) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (93 pliki, 9 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
