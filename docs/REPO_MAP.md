...
* **Liczba wszystkich plików:** 1566
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T15:56:51.095Z
...
- **apps/** (1161) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (678) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (636) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (355) — Powłoki Admin / Client / Timeline
...
│   │   │   ├── shells/
│   │   │   │   ├── admin/  … (48 plików, 5 podkatalogów; 33 pliki bezpośrednio)
│   │   │   │   ├── client/  … (31 plików, 1 podkatalog; 30 plików bezpośrednio)
│   │   │   │   ├── components/  … (59 plików, 1 podkatalog; 50 plików bezpośrednio)
│   │   │   │   ├── desktop/  … (19 plików)
│   │   │   │   ├── import/  … (37 plików, 1 podkatalog; 32 pliki bezpośrednio)
│   │   │   │   ├── pages/  … (3 pliki)
│   │   │   │   ├── settings/  … (21 plików, 1 podkatalog; 15 plików bezpośrednio)
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (135 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
