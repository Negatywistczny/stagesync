...
* **Liczba wszystkich plików:** 1403
* **Liczba katalogów:** 213
* **Data aktualizacji:** 2026-08-11T03:35:55.244Z
...
- **apps/** (1009) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (560) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (518) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (255) — Powłoki Admin / Client / Timeline
