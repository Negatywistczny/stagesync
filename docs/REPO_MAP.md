...
* **Liczba wszystkich plików:** 1528
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T02:47:52.994Z
...
- **apps/** (1124) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (644) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (602) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (321) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (108 plików, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
