...
* **Liczba wszystkich plików:** 1516
* **Liczba katalogów:** 252
* **Data aktualizacji:** 2026-08-11T22:45:35.982Z
...
- **apps/** (1112) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (632) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (590) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (309) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (96 plików, 9 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
