...
* **Liczba wszystkich plików:** 1564
* **Liczba katalogów:** 253
* **Data aktualizacji:** 2026-08-12T16:19:34.776Z
...
- **apps/** (1159) — Aplikacje wykonawcze i powłoki klienckie w monorepo
  ...
  - **web/** (692) — Aplikacja webowa React/Vite (Admin, Client, Timeline, Mikser)
    ...
    - **src/** (650) — Kod źródłowy UI i logiki klienta
      ...
      - **shells/** (369) — Powłoki Admin / Client / Timeline
...
│   │   │   │   ├── shared/  … (2 pliki)
│   │   │   │   └── timeline/  … (142 pliki, 10 podkatalogów; 13 plików bezpośrednio)
│   │   │   ├── transport/
│   │   │   │   ├── api.test.ts
│   │   │   │   ├── api.ts
