...
3. **„Zero-Crash” ≠ „zero glitch”:** WebAudio nadal może dropnąć sample / zablokować audio thread przy złym grafie; polityka zabrania *process crash* przez obcy kod wtyczek w procesie aplikacji, nie obiecuje bezbłędnego FOH.
