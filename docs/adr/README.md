...
Decision log StageSync v5. Spec / praktyka: [adr.github.io](https://adr.github.io/).
...
| **Zaakceptowany** | Obowiązująca decyzja |
| **Wycofany** | Nie obowiązuje; bez następcy |
| **Zastąpiony przez ADR NNNN** | Superseded — patrz nowszy rekord |
