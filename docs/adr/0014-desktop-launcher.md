...
8. **Close-to-tray (amendement — [#813](https://github.com/Negatywistczny/stagesync/issues/813)):** X na oknie nie zabija sidecara — tylko hide; host na żądanie nadal obowiązuje (brak auto-startu przy cold start). Pełny quit = tray/menu **Zakończ** / ⌘Q.
