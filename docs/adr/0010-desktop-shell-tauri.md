...
5. **Nawigacja desktop (amendement):** chrome HTML bez zmian względem przeglądarki (`appJump` Admin/Timeline). Natywne menu OS — **Faza A** (wdrożona):
   ...
   - **Fazy B–D** (Plik, Edycja, Transport, Host top-level, Audio/MIDI/DMX): [ROADMAP.md](../ROADMAP.md) § Desktop OS menu — **bez** gray-out „na zapas” w Fazie A.
