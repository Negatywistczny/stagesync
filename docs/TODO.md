...
**Stan:** `5.3.0` wydane 2026-07-25 na `main` (`v5.3.0`) — linia **5.3** = **Pocket Stage**; **5.2** = **Cue & Guard**; **5.1** = **Launch & Mix**; **5.0** = **Overture**.  
...
**Polityka:** residual po Cue & Guard / Pocket Stage → 5.3+ / Later. Zakaz stubów. [ADR 0011](./adr/0011-ui-parity-behavior.md).  
...
- [ ] **G1–G10** na instalatorach `v5.3.0` (mac/Win HW) — bez claim green; G2 skip; G3 re-verify HW; G7–G9 Docker deferred
