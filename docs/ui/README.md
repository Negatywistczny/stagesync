...
- Gęstość / spacing / hover: [[`.cursor/rules/ui-density.mdc`](../../.cursor/rules/ui-density.mdc)](../../.cursor/rules/ui-density.mdc).
- Animacje: `--ss-duration-fast` (120ms) / `normal` (200ms) / `slow` (700ms);
  hover przez `--ss-transition` (= fast + ease). Bez ad-hoc `0.7s` itd.
- Ikony shelli: **Lucide** przez [[`apps/web/src/shells/icons.tsx`](../../apps/web/src/shells/icons.tsx)](../../apps/web/src/shells/icons.tsx)
  — bez nowych lokalnych SVG w shellach.
- Wordmark: [[`apps/web/src/shells/ShellWordmark.tsx`](../../apps/web/src/shells/ShellWordmark.tsx)](../../apps/web/src/shells/ShellWordmark.tsx)
