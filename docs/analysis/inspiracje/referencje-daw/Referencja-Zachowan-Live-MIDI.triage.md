...
|----|--------|------|---------|
| REF-PC-01…09 | PC OUT on load, PC IN, debounce, batch, templates, panic, safeSend, clock z ticków, filtr kanału | częściowo `fixed` / `confirmed` | Kanał IN/OUT + debounce 50 ms = **teraz** ([ADR 0015](../../../adr/0015-daw-reference-and-product-decisions.md); RSK-04/05/07) |
