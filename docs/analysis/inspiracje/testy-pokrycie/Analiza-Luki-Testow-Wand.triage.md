...
**Status:** `closed`  
**Obszar:** `packages/shared` — [`wand.ts`](../../../../packages/shared/src/wand.ts)  
**Data triage:** 2026-07-27  
**Ostatnia weryfikacja:** 2026-07-27 — coverage [`wand.ts`](../../../../packages/shared/src/wand.ts) **95.59%** lines / **88.61%** branches
...
| TST-WND-03 | `TEXT_WEIGHT_RATIO_THRESHOLD` edge        | P2        | `fixed`    | [`wand.test.ts`](../../../../packages/shared/src/wand.test.ts) — Layer F uneven lines |
| TST-WND-04 | Countdown clips nieprzesuwane             | P0        | `rejected` | Test vl-cd-2 + skip countdown akordy (L250+, L894)                                    |
| TST-WND-05 | Fail-soft `ok: false` bez throw           | P1        | `fixed`    | [`wand.test.ts`](../../../../packages/shared/src/wand.test.ts) — ok:false matrix      |
| TST-WND-06 | `sealAkordyLengths` z ug-import           | P2        | `rejected` | Pokryte w [`ug-import.test.ts`](../../../../packages/shared/src/ug-import.test.ts)    |
