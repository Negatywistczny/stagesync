...
|----|--------|-----------|------|--------|
| TST-AST-01 | MIME / ext matrix | P1 | `fixed` | `assets-helpers.test.ts` |
| TST-AST-02 | Multipart `.flac`/`.mxl` + trackId/startTicks | P1 | `fixed` | `assets-router-unit.test.ts` |
...
| TST-AST-05 | Invalid `projectId` / `assetId` | P1 | `fixed` | `assets-router-unit.test.ts` |
