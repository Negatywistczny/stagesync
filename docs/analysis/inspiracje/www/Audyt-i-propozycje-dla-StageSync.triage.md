...
Korekta dumpu: [`channels.json`](../../../../apps/www/public/config/channels.json) → [`apps/www/public/config/channels.json`](../../../../apps/www/public/config/channels.json) (nie root monorepo).
...
| WWW-04 [`channels.json`](../../../../apps/www/public/config/channels.json) → Releases | `done`            | [`channels.ts`](../../../../apps/www/src/channels.ts) + `loadChannels()`                                   |
