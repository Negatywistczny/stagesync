...
- **On tree:** Operator PIN; host theme default; lokalny motyw Client.
- **Out:** scenic lock (było w `5.2.0`, usunięte post-cut).
- **Residual / skip:** 4-profile matrix; OAuth.
- **→ TODO:** Motywy residual (macierz 4 profili) w [TODO 5.2+](../../../TODO.md); PIN + host default poza TODO; OAuth OUT.

## Następny krok eng

1. Nie stubować „Zaloguj się” / OAuth (**skip** uzasadniony).
2. Cross-check [`docs/ui/colors.md`](../../../ui/colors.md) / ADR 0003 booth vs THM-03.
