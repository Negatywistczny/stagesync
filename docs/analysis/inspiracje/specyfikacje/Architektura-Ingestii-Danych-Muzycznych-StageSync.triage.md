...
**Companion:** [Analiza-Importu-ChordProUG.triage.md](../testy-pokrycie/Analiza-Importu-ChordProUG.triage.md) · [ADR 0002](../../../adr/0002-timebase-ssot.md) · `packages/shared` `ug-import.ts` / `schema.ts`
