...
| RM-08 Dual Engine (Studio vs Live) | `adr` | SSOT: [ADR 0019](../../../adr/0019-dual-engine-studio-live.md) |
| RM-09 VST Freeze Pipeline | `adr` | SSOT: [ADR 0018](../../../adr/0018-future-audio-architecture.md) §1 + [ADR 0019](../../../adr/0019-dual-engine-studio-live.md) §4 (sandbox sidecar; zakaz in-process) |
