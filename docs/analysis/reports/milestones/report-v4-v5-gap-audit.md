...
| ----- | -------------------------------------- | --------------- | ---------------------------------------------------- | ------ | ------------------------------------------- |
| CH-01 | Footer Admin-like (Utwór/Pozycja/Stan) | Conn-dot + zoom | **fixed** 2026-07-20 → dot+zooms                     | **P2** | inventarz-stub _(anti-pattern; obecnie OK)_ |
...
| ID    | Gap                           | v4 (fakt)                                               | v5 (fakt)                                                                | Sev    | Class                               |
| ----- | ----------------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------ | ------ | ----------------------------------- |
| AD-01 | Transpozycja zespołu          | Live Desk „Korekta na scenie” `#global-transpose` + API | **Brak UI** (2026-07-20: usunięto footer stub); API **ABSENT** → β2      | **P0** | deferred _(było inventarz-stub)_    |
...
| AD-04 | Placement Live Desk vs footer | Kontrole w karcie Live Desk                             | Footer stuby **usunięte**; przywrócić tylko z prawdziwym Live Desk / API | **P1** | inventarz-stub _(zamknięte chrome)_ |
