...
| H2  | [`Dockerfile`](../../../../Dockerfile) + [`compose.yml`](../../../../compose.yml); volume `./data` → `/app/data` — ścieżka drugorzędna (rack/server)                                                                                                                 | [ADR 0004](../../../adr/0004-updates-docker.md); [INSTALL.md](../../../guides/INSTALL.md) |
