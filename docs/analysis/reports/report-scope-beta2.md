...
1. **Audio 0…N** ([#42](https://github.com/Negatywistczny/stagesync/issues/42)) — clipy na Timeline, sync do ticków serwera (`ticksToMs`), trim/move, waveform, gain/mute (ADR 0008).
2. **Transport Countdown** ([#41](https://github.com/Negatywistczny/stagesync/issues/41)) — Play z pre-roll; Stop bez snap past CD (ADR 0002).
