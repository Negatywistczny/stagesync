...
const FALLBACK: SiteChannels = {
  ...
  docs: {
    install: "https://github.com/Negatywistczny/stagesync/blob/main/docs/INSTALL.md",
    desktop: "https://github.com/Negatywistczny/stagesync/blob/main/docs/DESKTOP.md",
    mobile: "https://github.com/Negatywistczny/stagesync/blob/main/docs/MOBILE.md",
