...
object ShellConfig {
    ...
    /** Role-specific Offline-First UI zip / health field (#692 dual entry). */
    const val UI_BUNDLE_FILENAME = "ui-bundle-performer.zip"
    const val UI_HASH_JSON_KEY = "uiHashPerformer"
