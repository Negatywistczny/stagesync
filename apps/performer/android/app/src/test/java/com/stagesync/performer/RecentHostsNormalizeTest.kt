...
class RecentHostsNormalizeTest {
    ...
    fun originFromQrPayload_extractsEmbeddedUrl() {
        assertEquals(
            "http://10.0.0.5:4000",
            RecentHosts.originFromQrPayload("Join StageSync http://10.0.0.5:4000/client now"),
        )
        assertEquals(
            "http://10.0.0.5:4000",
            RecentHosts.originFromQrPayload("http://10.0.0.5:4000/downloads/stagesync-performer.apk"),
        )
    }
