  ...
  },
  {
    ...
    bullets: [
      ...
      },
      {
        term: "Mikser",
        detail:
          "ikona obok Tempo (X); pionowe paski: M / ST (PAN vs True Balance BAL), ciemny baner z cienkim paskiem koloru ścieżki, fader z podziałką, peak LED (mono 1 pasek / stereo L+R; zielony / żółty −6 / czerwony clip), S/M; Wyjście = Master|magistrala; Magistrale / Click / Master z muted banerami; przypięty Stereo Out.",
      },
      {
        term: "Dock",
        detail:
