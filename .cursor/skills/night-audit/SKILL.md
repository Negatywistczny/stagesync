...
2. Odczytaj [docs/TODO.md](../../../docs/TODO.md) i ostatni handoff w `docs/analysis/reports/report-*-hygiene-*.md` (jeśli jest).
...
- Kanoniczny: `docs/analysis/reports/report-{nightshift|evening}-hygiene-YYYY-MM-DD.md`
